...
SPEC =
  Gem::Specification.new do |s|
    ...
    s.description = <<~EOF
    The finrb library (forked from the finance gem) provides a Ruby interface for working with interest rates, mortgage amortization and cashflows (NPV, IRR, etc.)
